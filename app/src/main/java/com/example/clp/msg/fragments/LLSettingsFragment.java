...
import com.example.clp.msg.R.id;
import com.example.clp.msg.R.layout;
...
public class LLSettingsFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		mCheckBackground = (CheckBox) rootView.findViewById(id.check_background_service);
		...
		mTextIot = (TextView) rootView.findViewById(id.text_iot_guide);
