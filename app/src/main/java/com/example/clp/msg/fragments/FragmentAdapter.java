...
import com.example.clp.msg.R.string;
...
public class FragmentAdapter extends FragmentPagerAdapter {
	...
	public CharSequence getPageTitle(int position) {
		...
		case FRAGMENT_POS_EXAMPLE:
			return mContext.getString(string.title_example).toUpperCase(l);
		case FRAGMENT_POS_SETTINGS:
			return mContext.getString(string.title_ll_settings).toUpperCase(l);
		}
		return null;
	}
